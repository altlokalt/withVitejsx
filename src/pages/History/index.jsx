...
const HistoryPage = () => {
  ...
  return (
    <>
      <div className="bg-gray_907 flex sm:flex-col md:flex-col flex-row font-outfit sm:gap-[20px] md:gap-[20px] items-start mx-[auto] pb-[15px] pr-[15px] w-[100%]">
        ...
        <div className="flex flex-1 flex-col mb-[30px] md:px-[20px] relative w-[100%]">
          ...
          <div className="flex font-urbanist items-center justify-start mt-[-6.15px] mx-[auto] w-[97%] z-[1]">
            <div className="flex flex-col gap-[21px] items-start justify-start w-[100%]">
              ...
              <div className="overflow-auto bg-white_A700 outline outline-[0.5px] outline-gray_123 rounded-[60px] shadow-bs70 w-[100%]">
                <ReactTable
                  columns={column1}
