...
const BrowsePage = () => {
  ...
  return (
    <>
      <div className="bg-bluegray_930 font-dmsans h-[1140px] mx-[auto] pr-[181px] sm:pr-[20px] md:pr-[40px] relative w-[100%]">
        <div className="flex h-[100%] items-center justify-start ml-[288px] mt-[120px] w-[49%]">
          <div
        ...
        <div className="absolute bottom-[0] h-[2291px] left-[0] md:w-[100%] w-[89%]">
          <div className="flex h-[100%] items-center justify-start m-[auto] w-[100%]">
            <div className="flex md:flex-col flex-row md:gap-[40px] items-start justify-between w-[100%]">
                ...
                <div className="flex items-center justify-start w-[100%]">
                  <div className="flex flex-row items-start justify-evenly w-[100%]">
                    <div className="bg-gray_941 flex flex-1 flex-col items-start justify-start mb-[1092px] py-[132px] w-[100%]">
                      <div className="flex items-center justify-start md:ml-[0] ml-[32px] md:w-[100%] w-[43%]">
                      ...
                      <div className="flex items-center justify-start md:ml-[0] ml-[16px] mt-[32px] md:w-[100%] w-[88%]">
                        <div className="bg-yellow_905 flex flex-row gap-[16px] items-center justify-start p-[16px] rounded-[8px] w-[100%]">
                          <Img
                            src="images/img_map_white_a700_24x24.svg"
                            className="h-[24px] w-[24px]"
                            alt="map"
                          />
                          <Text
              ...
              <div className="flex flex-1 items-center justify-start md:mt-[0] mt-[406px] w-[100%]">
                <div className="flex flex-col gap-[36px] items-center justify-start w-[100%]">
                  <div className="flex sm:flex-col flex-row sm:gap-[48px] items-start justify-between md:w-[100%] w-[97%]">
                    <Text
                      className="font-bold mb-[2px] text-left text-yellow_905 tracking-[0.12px] w-[auto]"
                      variant="body37"
                    >
                      New Release
                    </Text>
                    <Text
                      className="font-bold text-bluegray_300 text-left tracking-[0.12px] w-[auto]"
                      variant="body37"
                    >
                      Popular
                    </Text>
                    <Text
                      className="font-bold mb-[2px] text-bluegray_300 text-left tracking-[0.12px] w-[auto]"
                      variant="body37"
                    >
                      Artist
                    </Text>
                    ...
                    <Text
                      className="font-bold sm:mt-[0] mt-[2px] text-bluegray_300 text-left tracking-[0.12px] w-[auto]"
                      variant="body37"
                    >
                      Song
                    </Text>
                  ...
                  <div className="md:gap-[20px] gap-[24px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-[100%]">
                    <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                      <div className="bg-bluegray_805 h-[200px] rounded-[8px] w-[100%]"></div>
                      <Text
                        className="font-bold mt-[25px] text-left text-white_A700 tracking-[0.12px] w-[auto]"
                        variant="body37"
                      >
                        Sunday Morning
                      </Text>
                      <Text
                        className="font-bold mt-[10px] text-center text-yellow_905 tracking-[0.08px] w-[auto]"
                        variant="body50"
                      >
                        Maroon Five
                      </Text>
                    ...
                    <div className="flex flex-1 flex-col items-center justify-start w-[100%]">
                      <div className="bg-bluegray_805 h-[200px] rounded-[8px] w-[100%]"></div>
                      <Text
                        className="font-bold mt-[24px] text-left text-white_A700 tracking-[0.12px] w-[auto]"
                        variant="body37"
                      >
                        Sunday Morning
                      </Text>
                      <Text
                        className="font-bold mt-[16px] text-center text-yellow_905 tracking-[0.08px] w-[auto]"
                        variant="body50"
                      >
                        Maroon Five
                      </Text>
              ...
              <div className="bg-gray_941 flex flex-1 flex-col items-center justify-start mb-[956px] md:mt-[0] mt-[80px] py-[36px] w-[100%]">
