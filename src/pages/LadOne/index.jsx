        ...
        <div className="flex flex-col items-center justify-start w-[100%]">
              ...
              <div className="bg-white_A700 border-b-[1px] border-black_905 border-solid flex items-center justify-center w-[100%]">
                <div className="flex flex-col items-center justify-center w-[100%]">
                  ...
                  <div className="bg-white_A700 flex items-center justify-start w-[100%]">
                    <div className="md:h-[50px] h-[76px] p-[9px] relative w-[100%]">
                      ...
                      <div className="absolute bottom-[0] flex flex-row gap-[4px] items-start justify-center pb-[6.84px] pr-[8.3px] right-[38%] w-[auto]">
          ...
          <div className="flex flex-col md:px-[20px] relative w-[100%]">
            <div className="flex flex-col items-start justify-start mx-[auto] pb-[69px] w-[100%]">
              ...
              <div className="bg-gray_62 border-black_905 border-solid border-t-[1px] font-roboto sm:h-[1530px] md:h-[353px] h-[361px] md:ml-[0] ml-[168px] relative md:w-[100%] w-[92%]">
                <div className="absolute bg-gray_62 border-black_905 border-solid border-t-[1px] h-[353px] inset-y-[0] left-[0] my-[auto] w-[94%]"></div>
                <div className="absolute flex flex-col gap-[26px] md:h-[auto] h-[max-content] inset-[0] items-start justify-start m-[auto] max-w-[1752px] pt-[36px] w-[100%]">
              ...
              <div className="border-b-[1px] border-black_905 border-solid flex flex-col font-inter items-start justify-start mt-[2px] p-[64px] sm:px-[20px] md:px-[40px] w-[100%]">
              ...
              <div className="border-b-[1px] border-black_905 border-solid flex font-inter items-center justify-start mt-[38px] pb-[16px] px-[16px] w-[100%]">
              ...
              <div className="border-b-[1px] border-black_905 border-solid flex md:flex-col flex-row font-inter md:gap-[40px] items-start justify-between mt-[80px] w-[100%]">
                ...
                <div className="flex md:flex-1 flex-col items-start justify-start md:mt-[0] mt-[64px] pt-[5px] md:w-[100%] w-[30%]">
                  ...
                  <div className="flex flex-col gap-[4px] items-start justify-start mt-[23px] sm:w-[100%] w-[auto]">
                    ...
                    <div className="flex flex-row gap-[8px] items-center justify-start pr-[3px] py-[3px] w-[100%]">
                      ...
                      <Text
                        className="font-normal mt-[3px] not-italic text-gray_974 text-left w-[auto]"
                        variant="body47"
                      >
              ...
              <div className="border-b-[1px] border-black_905 border-solid flex font-inter items-center justify-start mt-[23px] w-[100%]">
                <List
            ...
            <div className="bg-bluegray_946 flex items-center justify-center mt-[-42.25px] mx-[auto] p-[22px] sm:px-[20px] rounded-[16px] w-[99%] z-[1]">
