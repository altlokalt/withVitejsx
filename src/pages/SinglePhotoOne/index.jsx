...
const SinglePhotoOnePage = () => {
  return (
    <>
      <div className="bg-gray_103 font-inter h-[874px] mx-[auto] relative w-[100%]">
        <div
          className="absolute bg-cover bg-no-repeat bottom-[0] flex h-[1024px] items-end justify-end pl-[85px] md:px-[20px] right-[0] w-[89%]"
        ...
        >
          <div className="flex md:flex-col flex-row gap-[49px] items-start justify-end w-[100%]">
            <div className="flex md:flex-1 flex-col md:gap-[40px] gap-[69px] items-center justify-start md:mt-[0] mt-[40px] md:w-[100%] w-[59%]">
              <div className="flex flex-row sm:gap-[40px] items-center justify-between md:w-[100%] w-[96%]">
                ...
                <div className="flex flex-row gap-[10px] items-center justify-between w-[19%]">
                  <Text
        ...
        <Img
          ...
          className="absolute h-[874px] inset-y-[0] left-[0] my-[auto] w-[auto]"
...
export default SinglePhotoOnePage;
